    ...
    stages {
        ...
        stage('Before Script') {
            steps {
                ...
                sh 'echo "java_properties=-Dspinnaker.parallel_tasks=10 -Dlogging.level=DEBUG" >> ~/.spynnaker.cfg'
                ...
                sh 'echo "java_properties=-Dspinnaker.parallel_tasks=10 -Dlogging.level=DEBUG" >> ~/.spiNNakerGraphFrontEnd.cfg'
