...
def create_spynnaker_config() {
    ...
    sh '''
        ...
        then
            ...
            echo "spalloc_server = https://jenkins:jenkins@spinnaker.cs.man.ac.uk" >> ~/.spynnaker.cfg
...
def create_gfe_config() {
    ...
    sh '''
        ...
        then
            ...
            echo "spalloc_server = https://jenkins:jenkins@spinnaker.cs.man.ac.uk" >> ~/.spiNNakerGraphFrontEnd.cfg
